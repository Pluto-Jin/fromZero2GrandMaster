...
syn keyword cppFunction		fill resize swap lower_bound upper_bound sort stable_sort reverse merge unique binary_search gcd lcm stoi stol stoll iota __builtin_popcount
